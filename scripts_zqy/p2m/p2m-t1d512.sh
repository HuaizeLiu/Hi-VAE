...
accelerate launch \
  ...
  --name $1\
  --exp_root /mnt/pfs-gv8sxa/tts/dhg/zqy/newexp/p2m \
  ...
  --path_type dir \
  --dataset_type A2MVideoAudioPoseRandomRef \
  --sample_size '[256,256]'\
  --sample_stride 1\
  --sample_n_frames 16\
  --batch_size 12\
  ...
  --save_checkpoint_interval_step 500\
  --num_workers 16 \
  --lr 0.0001 \
  ...
  --amd_config /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-spatial/config.json \
  --amd_ckpt /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-spatial/checkpoints/checkpoint-131000/model.safetensors \
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/p2m/p2m_t1d512.yaml \
  --a2m_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/cache_ckpt/p2m_t1d512.safetensor \

  # --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/newexp/a2m-t1d512-f16-pose-spatial/checkpoints/checkpoint-27500\

...
accelerate launch \
  ...
  --resume_training /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-motion-transformer-new/checkpoints/checkpoint-85000\

  # --amd_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-motion-transformer/checkpoints/checkpoint-495000/model.safetensors\

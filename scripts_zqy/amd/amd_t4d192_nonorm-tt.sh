...
accelerate launch \
  ...
  --train_datapath /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/code/AMD2/dataset/path/amd2-hdtf/train.pkl\
  --eval_datapath /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/code/AMD2/dataset/path/amd2-hdtf/eval.pkl\

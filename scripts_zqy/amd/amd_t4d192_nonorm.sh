...
accelerate launch \
  ...
  --train_datapath /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/code/AMD2/dataset/path/amd2-withouthdtf/train.pkl\
  --eval_datapath /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/code/AMD2/dataset/path/amd2-withouthdtf/eval.pkl\
  ...
  --amd_num_step 1000\
  --motion_token_num 4\
  --motion_token_channel 192\
  --motion_need_norm_out false\
  --resume_training /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t4-d192-nonorm/checkpoints/checkpoint-54000\

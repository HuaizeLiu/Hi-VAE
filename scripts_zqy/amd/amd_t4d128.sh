...
accelerate launch \
  ...
  --resume_training /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/exp/amd-s-t4-d128/checkpoints/checkpoint-19000\
  # --amd_from_config /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/exp/amd-s-t8-d128/config.json\

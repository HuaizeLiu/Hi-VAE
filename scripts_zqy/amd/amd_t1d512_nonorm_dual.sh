...
accelerate launch \
  ...
  --amd_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-dual/checkpoints/checkpoint-60000/model.safetensors\

  # --resume_training /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-dual/checkpoints/checkpoint-24000\

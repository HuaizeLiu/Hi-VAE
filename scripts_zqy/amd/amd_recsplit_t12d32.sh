...
accelerate launch \
  ...
  --amd_model_type AMD_S_RecSplit\
  --amd_image_patch_size 2\
  --amd_motion_patch_size 1\
  --amd_num_step 1000\
  --motion_token_num 12\
  --motion_token_channel 32\
  --resume_training /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/exp/amd-s-recsplit-t12-d32/checkpoints/checkpoint-10000\

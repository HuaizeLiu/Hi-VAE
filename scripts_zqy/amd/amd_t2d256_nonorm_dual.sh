...
accelerate launch \
  ...
  --diffusion_model_type dual\
  --amd_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-dual/checkpoints/checkpoint-59000/model.safetensors\
  # --resume_training /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-dual/checkpoints/checkpoint-23000\

...
accelerate launch \
  ...
  --amd_num_step 1000\
  --motion_token_num 12\
  --motion_token_channel 16\
  # --resume_training /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/exp/amd-s-t12-d64/checkpoints/checkpoint-220000\

...
accelerate launch \
  ...
  --amd_num_step 1000\
  --motion_token_num 1\
  --motion_token_channel 1024\
  # --resume_training /mnt/pfs-mc0p4k/tts/team/digital_avatar_group/sunwenzhang/qiyuan/exp/amd-s-t12-d128/checkpoints/checkpoint-119000\

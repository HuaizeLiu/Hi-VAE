...
accelerate launch \
  ...
  --need_motion_transformer true\
  --resume_training /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-motion-transformer-new/checkpoints/checkpoint-20000\

  # --amd_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-motion-transformer/checkpoints/checkpoint-506000/model.safetensors\

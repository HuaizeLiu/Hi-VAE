...
-c "bash /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/scripts/a2m_new/$1 $2" \
-p dhg-a800
...
# bash lizrun.sh a2m-t1d512-spatial.sh a2m-t1d512-f8-spatial
# lizrun logs a2m-t1d512-f8-spatial-didonglin-master-0 -f
# lizrun login a2m-t1d512-f8-spatial-didonglin-master-0    
# lizrun stop a2m-t1d512-f8-spatial-didonglin 


# bash lizrun.sh a2m-t1d512-spatial.sh a2m-t1d512-f16-spatial
...
# bash lizrun.sh a2m-t1d512-posepre-spatial.sh a2m-t1d512-f16-posepre-spatial
...
# bash lizrun.sh a2m-t1d512-pose-spatial.sh a2m-t1d512-f16-pose-spatial
# lizrun logs a2m-t1d512-f16-pose-spatial-didonglin-master-0 -f
# lizrun login a2m-t1d512-f16-pose-spatial-didonglin-master-0    
# lizrun stop a2m-t1d512-f16-pose-spatial-didonglin 

# bash lizrun.sh a2m-t2d256-spatial.sh a2m-t2d256-f16-spatial
...
# bash lizrun.sh a2m-t2d256-posepre-spatial.sh a2m-t2d256-f16-posepre-spatial

...
accelerate launch \
  ...
  --amd_ckpt /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-spatial/checkpoints/checkpoint-55000/model.safetensors  \
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/a2m_t1d512_pose.yaml \
  --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/newexp/a2m-t1d512-f16-pose-spatial/checkpoints/checkpoint-27500\
  # --a2m_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/a2m-token1-frame16-pose-motion-wo-mt/checkpoints/checkpoint-24000/model.safetensors \

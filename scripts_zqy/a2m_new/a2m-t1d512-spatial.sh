...
accelerate launch \
  ...
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/a2m_t1d512.yaml \
  --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/newexp/a2m-t1d512-f16-spatial/checkpoints/checkpoint-28500\
  # --a2m_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/a2m-token1-frame16-motion-wo-mt/checkpoints/checkpoint-350000/model.safetensors \

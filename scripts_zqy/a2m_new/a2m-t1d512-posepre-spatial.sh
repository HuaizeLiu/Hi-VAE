...
accelerate launch \
  ...
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/a2m_t1d512_posepre.yaml \
  --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/newexp/a2m-t1d512-f16-posepre-spatial/checkpoints/checkpoint-23000\
  # --a2m_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/a2m-token1-frame16-posepre-motion-wo-mt/checkpoints/checkpoint-320000/model.safetensors \

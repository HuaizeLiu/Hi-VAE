...
accelerate launch \
  ...
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/a2m_t2d256.yaml \
  --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/newexp/a2m-t2d256-f16-spatial/checkpoints/checkpoint-28000\

  # --a2m_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/a2m-token2-frame16-motion-wo-mt/checkpoints/checkpoint-366000/model.safetensors\

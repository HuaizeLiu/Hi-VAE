...
accelerate launch \
  ...
  --amd_config /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-motion-transformer/config.json \
  --amd_ckpt /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-motion-transformer/checkpoints/checkpoint-419000/model.safetensors \
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/cross_audio_pose_t2d256_l16_dim1024.yaml \

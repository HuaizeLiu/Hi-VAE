...
accelerate launch \
  ...
  --amd_ckpt /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-motion-transformer/checkpoints/checkpoint-506000/model.safetensors \
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/cross_audio_pose_t1d512_l16_dim1024.yaml \
  # --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/a2m-dwpose-token2-frame16/checkpoints/checkpoint-249000\

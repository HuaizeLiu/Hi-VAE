...
accelerate launch \
  ...
  --amd_ckpt /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t2-d256-nonorm-spatial/checkpoints/checkpoint-9000/model.safetensors \
  --a2m_config /mnt/pfs-gv8sxa/tts/dhg/zqy/code/AMD2/config/a2m/cross_audio_t2d256_l16_dim1024.yaml \
  --resume_from_checkpoint /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/a2m-token2-frame16/checkpoints/checkpoint-240000\

...
if __name__ == "__main__":
    input_video = "/mnt/pfs-gv8sxa/tts/dhg/liuhuaize/code/AMD2/exp_lhz/example/1012177310.mp4"
    name = "无主体，向前_1"
    ...
    direction_var_threshold=6 # 值越小，代表对相机运动筛选越严格
    direction_threshold=0.2 # 值越小，代表对相机运动筛选越严格


    mask,_ = flow_mask(input_video,0,30,l_window_size, s_window_size,flow_mag_threshold,direction_var_threshold,direction_threshold,name)
    cv2.imwrite(f"/mnt/pfs-gv8sxa/tts/dhg/liuhuaize/code/AMD2/exp_diff/windows_{s_window_size}/{name}_grid_mask_camera_1.jpg",mask)

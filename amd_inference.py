...
from model.pipeline import A2VPipeLine,AMDTestPipeLine,A2VInferencePipeLine,AMDPipeLine,AMDPipeLine_single
...
def get_cfg():
    ...
    parser.add_argument('--data_dir', default='/mnt/pfs-mc0p4k/cvg/team/didonglin/zqy/exp')
    ...
    parser.add_argument('--use_cross',type= str2bool,default=False)
    # checkpoints
...
if __name__ == '__main__':
    ...
    videos_path =  glob.glob(os.path.join(args.data_dir, '**', '*.*'), recursive=True)
    ...
    for v in videos_path:
        try:
            ...
            save_path_gt = os.path.join(save_dir,name+'_gt.mp4')

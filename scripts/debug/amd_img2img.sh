...
accelerate launch \
  ...
  --train_datapath /mnt/pfs-gv8sxa/tts/dhg/wenzhangsun/.sun/dataset/realestate10k/testdata.csv\
  ...
  --use_mask true\
  --motion_type plus\
  --amd_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/liuhuaize/code/AMD2/img_exp/vidtok-img2img-fq-grey-cd-c32m64-t9-highfq-stage2/checkpoints/checkpoint-108000/model.safetensors
...
# /mnt/pfs-gv8sxa/tts/dhg/wenzhangsun/.sun/dataset/webvid/vidtwin_csv/final.csv
...
#   --mask_video_ratio 0.7\
#   --use_mask true
  # --amd_from_pretrained /mnt/pfs-gv8sxa/tts/dhg/liuhuaize/code/AMD2/img_exp/vidtok-img2img-fq-grey-cd-c32m64-t9-cameraonly/checkpoints/checkpoint-92000/model.safetensors
#   --resume_training /mnt/pfs-gv8sxa/tts/dhg/zqy/exp/amd-s-t1-d512-nonorm-spatial/checkpoints/checkpoint-57000\

...
def gaussian_low_pass_filter(shape, d_s=0.25, d_t=0.25):
    ...
    Args:
        ...
        控制空间维度的截止频率(Normalized stop frequency),值范围是 0 到 1,越小意味着过滤掉更多高频成分
        d_t: normalized stop frequency for temporal dimension (0.0-1.0)
        控制时间维度的截止频率(Normalized stop frequency),值范围是 0 到 1,越小意味着过滤掉更多高频成分
    """
